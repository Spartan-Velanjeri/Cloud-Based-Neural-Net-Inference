...
'''
docker run -p 8501:8501 --mount type=bind, source=/home/typlosion/work/ACDC/tfserving_acdc/keras_example/model/1/,target=/models/mobilenet/1/ -e MODEL_NAME=mobilenet -t tensorflow/serving
