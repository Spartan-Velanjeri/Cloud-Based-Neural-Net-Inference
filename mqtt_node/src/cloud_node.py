...
class CloudNode:
    def __init__(self, model_path, xml_path, use_saved_model):
        ...
        # for image manipulation/transformation
        ...
        #setup MQTT Client
        self.mqtt_client = mqtt.Client() # Publish segmented images to vehicle node
        # self.mqtt_sub_client = mqtt.Client() # Subscribe camera images from vehicle node
        self.mqtt_client.connect(MQTT_BROKER_IP,MQTT_BROKER_PORT) #same client as the segmented image subscribing on vehicle node
        ...
        self.mqtt_client.subscribe(MQTT_SUB_CAMERA_TOPIC)
...
if __name__ == '__main__':
    ...
    if args.use_saved_model:
        print(">> Using saved model: ", args.model_path)
